...
void RtcInit( void )
{
    ...
    if( RtcInitialized == false )
    {
        ...
        RtcHandle.Init.AsynchPrediv   = PREDIV_A;  // RTC_ASYNCH_PREDIV;127;//
        RtcHandle.Init.SynchPrediv    = PREDIV_S;  // RTC_SYNCH_PREDIV;255;//
...
void RtcStartAlarm( uint32_t timeout )
{
    ...
    RtcAlarm.AlarmSubSecondMask       = ALARM_SUBSECOND_MASK;//RTC_ALARMSUBSECONDMASK_ALL;//
